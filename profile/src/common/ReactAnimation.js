...
function Atom(props) {
  ...
  return (
    <group {...props}>
      <Line worldUnits points={points} color="#88cfda" lineWidth={0.3} />
      <Line worldUnits points={points} color="#88cfda" lineWidth={0.3} rotation={[0, 0, 1]} />
      <Line worldUnits points={points} color="#88cfda" lineWidth={0.3} rotation={[0, 0, -1]} />
      ...
      <Sphere args={[0.55, 64, 64]}>
        <meshBasicMaterial color={[2, 0.5, 2]} toneMapped={false} />
      </Sphere>
    </group>
  )
}
